-- ========================================
-- POPOLAMENTO DATI MANCANTI (VERSIONE SICURA)
-- ========================================

-- 1. ABILITA RLS SE NON È GIÀ ABILITATO
ALTER TABLE public.user_roles ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.permissions ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.role_permissions ENABLE ROW LEVEL SECURITY;

-- 2. CREA POLITICHE PER LETTURA
DO $$
BEGIN
...
-- 3. INSERISCI I RUOLI MANCANTI (senza cancellare quelli esistenti)
...
-- 4. PULISCI E INSERISCI I PERMESSI (questo è sicuro da cancellare)
...
-- 5. PULISCI E INSERISCI I COLLEGAMENTI RUOLO-PERMESSI
...
-- Dirigente: quasi tutto tranne gestione utenti completa
INSERT INTO public.role_permissions (role_id, permission_id)
SELECT ur.id, p.id
FROM public.user_roles ur, public.permissions p
