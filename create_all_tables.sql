...
-- 3. Crea la tabella fee_assignments (dipende da fees e people)
...
-- 5. Crea indici per fee_assignments
...
WHERE table_schema = 'public' 
AND table_type = 'BASE TABLE'
AND table_name IN ('fees', 'fee_assignments', 'people')
ORDER BY table_name;
